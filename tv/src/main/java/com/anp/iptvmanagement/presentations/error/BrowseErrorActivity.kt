...
import com.anp.iptvmanagement.R.id
...
class BrowseErrorActivity : Activity() {
  ...
  private fun testError() {
    ...
    fragmentManager.beginTransaction().add(id.main_browse_fragment, mErrorFragment).commit()

    mSpinnerFragment = SpinnerFragment()
    fragmentManager.beginTransaction().add(id.main_browse_fragment, mSpinnerFragment).commit()
